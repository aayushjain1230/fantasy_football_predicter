...
DEGRADATION_MATRIX = [
    {"Failure": "ESPN unavailable", "Expected behavior": "Keep current session state when present; otherwise require a live ESPN connection.", "Feature": "Connection"},
    ...
    {"Failure": "ESPN projection missing", "Expected behavior": "Mark that player's projection and dependent recommendation unavailable.", "Feature": "Projections"},
...
PERFORMANCE_BUDGETS = [
    {"Operation": "Initial connection screen render", "Budget": "under 5 seconds"},
    ...
    {"Operation": "Waiver ranking", "Budget": "under 5 seconds for normal ESPN free-agent pools"},
