...
class ProjectionService:
    ...
    def project_player(self, player: Player, league: League | None = None, week: int | None = None, context: ProjectionContext | None = None) -> Projection:
        ...
        return Projection(
            ...
            median=round(expected, 2),
            floor=round(lower, 2),
            ceiling=round(upper, 2),
            ...
            reasons=["Projection generated by a position-specific historical model.", "Feature values are pregame or shifted historical aggregates."],
            missing=missing,
